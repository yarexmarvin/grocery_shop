...
const BasketButton: FC<ProductButton> = ({ label, style, variant = "secondary", iconStart, }) => {
  ...
  return (
    <button style={style} onClick={() => setItemCount(1)} className={`${isSecondary ? styles.secondary : styles.primary} ${styles.button}`}>
      <>
        {iconStart}
        {label}
      </>
